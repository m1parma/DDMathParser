...
extension Function {
    ...
    static let add = Function(name: "add", evaluator: { state throws -> Double in
    ...
    static let subtract = Function(name: "subtract", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let multiply = Function(names: ["multiply", "implicitmultiply"], evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let divide = Function(name: "divide", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let mod = Function(names: ["mod", "modulo"], evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let negate = Function(name: "negate", evaluator: { state throws -> Double in
    ...
    static let factorial = Function(name: "factorial", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let factorial2 = Function(name: "factorial2", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let pow = Function(name: "pow", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let sqrt = Function(name: "sqrt", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let cuberoot = Function(name: "cuberoot", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let nthroot = Function(name: "nthroot", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let random = Function(name: "random", evaluator: { state throws -> Double in
        guard state.arguments.count <= 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let log = Function(name: "log", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let ln = Function(name: "ln", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let log2 = Function(name: "log2", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let exp = Function(name: "exp", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let abs = Function(name: "abs", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let percent = Function(name: "percent", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let and = Function(name: "and", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let or = Function(name: "or", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let not = Function(name: "not", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let xor = Function(name: "xor", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let rshift = Function(name: "rshift", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let lshift = Function(name: "lshift", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let average = Function(names: ["average", "avg", "mean"], evaluator: { state throws -> Double in
    ...
    static let sum = Function(names: ["sum", "∑"], evaluator: { state throws -> Double in
        guard state.arguments.count > 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let product = Function(names: ["product", "∏"], evaluator: { state throws -> Double in
        guard state.arguments.count > 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let count = Function(name: "count", evaluator: { state throws -> Double in
        return Double(state.arguments.count)
    })
    
    static let min = Function(name: "min", evaluator: { state throws -> Double in
        guard state.arguments.count > 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let max = Function(name: "max", evaluator: { state throws -> Double in
        guard state.arguments.count > 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let median = Function(name: "median", evaluator: { state throws -> Double in
        guard state.arguments.count >= 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let stddev = Function(name: "stddev", evaluator: { state throws -> Double in
        guard state.arguments.count >= 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let ceil = Function(name: "ceil", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let floor = Function(names: ["floor", "trunc"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let sin = Function(name: "sin", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let cos = Function(name: "cos", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let tan = Function(name: "tan", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let asin = Function(names: ["asin", "sin⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acos = Function(names: ["acos", "cos⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let atan = Function(names: ["atan", "tan⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let atan2 = Function(name: "atan2", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let csc = Function(name: "csc", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let sec = Function(name: "sec", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let cotan = Function(name: "cotan", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acsc = Function(names: ["acsc", "csc⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let asec = Function(names: ["asec", "sec⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acotan = Function(names: ["acotan", "cotan⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let sinh = Function(name: "sinh", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let cosh = Function(name: "cosh", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let tanh = Function(name: "tanh", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let asinh = Function(names: ["asinh", "sinh⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acosh = Function(names: ["acosh", "cosh⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let atanh = Function(names: ["atanh", "tanh⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let csch = Function(name: "csch", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let sech = Function(name: "sech", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let cotanh = Function(name: "cotanh", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acsch = Function(names: ["acsch", "csch⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let asech = Function(names: ["asech", "sech⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let acotanh = Function(names: ["acotanh", "cotanh⁻¹"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let versin = Function(names: ["versin", "vers", "ver"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let vercosin = Function(names: ["vercosin", "vercos"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let coversin = Function(names: ["coversin", "cvs"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let covercosin = Function(name: "covercosin", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let haversin = Function(name: "haversin", evaluator: { state throws -> Double in
        return try versin.evaluator(state) / 2.0
    })
    
    static let havercosin = Function(name: "havercosin", evaluator: { state throws -> Double in
        return try vercosin.evaluator(state) / 2.0
    })
    
    static let hacoversin = Function(name: "hacoversin", evaluator: { state throws -> Double in
        return try coversin.evaluator(state) / 2.0
    })
    
    static let hacovercosin = Function(name: "hacovercosin", evaluator: { state throws -> Double in
        return try covercosin.evaluator(state) / 2.0
    })
    
    static let exsec = Function(name: "exsec", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let excsc = Function(name: "excsc", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let crd = Function(names: ["crd", "chord"], evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let dtor = Function(name: "dtor", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let rtod = Function(name: "rtod", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let `true` = Function(names: ["true", "yes"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return 1.0
    })
    
    static let `false` = Function(names: ["false", "no"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return 0.0
    })
    
    static let phi = Function(names: ["phi", "ϕ"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return 1.6180339887498948
    })
    
    static let pi = Function(names: ["pi", "π", "tau_2"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return Double.pi
    })
    
    static let pi_2 = Function(names: ["pi_2", "tau_4"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return Double.pi / 2
    })
    
    static let pi_4 = Function(names: ["pi_4", "tau_8"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return Double.pi / 4
    })
    
    static let tau = Function(names: ["tau", "τ"], evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return 2 * Double.pi
    })
    
    static let sqrt2 = Function(name: "sqrt2", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return 2.squareRoot()
    })
    
    static let e = Function(name: "e", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return M_E
    })
    
    static let log2e = Function(name: "log2e", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return M_LOG2E
    })
    
    static let log10e = Function(name: "log10e", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return M_LOG10E
    })
    
    static let ln2 = Function(name: "ln2", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return M_LN2
    })
    
    static let ln10 = Function(name: "ln10", evaluator: { state throws -> Double in
        guard state.arguments.count == 0 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
        return M_LN10
    })
    ...
    static let l_and = Function(name: "l_and", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_or = Function(name: "l_or", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_not = Function(name: "l_not", evaluator: { state throws -> Double in
        guard state.arguments.count == 1 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_eq = Function(name: "l_eq", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_neq = Function(name: "l_neq", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_lt = Function(name: "l_lt", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_gt = Function(name: "l_gt", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_ltoe = Function(name: "l_ltoe", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_gtoe = Function(name: "l_gtoe", evaluator: { state throws -> Double in
        guard state.arguments.count == 2 else { throw MathParserError(kind: .invalidArguments, range: state.expressionRange) }
    ...
    static let l_if = Function(names: ["l_if", "if"], evaluator: { state throws -> Double in
